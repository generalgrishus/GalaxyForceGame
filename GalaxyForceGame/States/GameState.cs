using GalaxyForceGame.Entities;
    ...
    public class GameState : State
    {
        ...
        private void Restart()
        {
            ...
            sprites = new List<Sprite>()
            {
                ...
                //{
                //    Position = new Vector2(Game1.ScreenWidth/2,Game1.ScreenHeight-210),
                //    Bullet = new Bullet(ContentManager.Load<Texture2D>("playerShot")),
                //    InputInfo = new InputInfo()
                //    {
                //        Left = Keys.Left,
                //        Right = Keys.Right,
            ...
            icons = new List<Icon>()
            {
                new Icon(ContentManager.Load<Texture2D>("gameBackGround"))
                {
                    Position = new Vector2(0,0),
                    LayerRatio = 0.01f,
                },
                new Icon(ContentManager.Load<Texture2D>("GameBar"))
                {
                    Position = new Vector2(0,Game1.ScreenHeight-200),
                    LayerRatio = 0.1f,
                },
                new Icon(ContentManager.Load<Texture2D>("IconUltimate"))
                {
                ...
                new Icon(ContentManager.Load<Texture2D>("Shield_Icon"))
                {
        ...
        private void CreateGameBarTitles(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(Score.Font, string.Format("Player kills : {0}", Score.AmountOfKills),
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            foreach (var sprite in sprites.ToArray())
            {
                if (sprite is Player)
                {
                    ...
                    if (player.PlayerScore.AmountOfKills >= 150 || player.GoExit)
                    {
